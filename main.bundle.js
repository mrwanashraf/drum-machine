...
/* harmony import */ var _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
function (_React$Component) {
  ...
  function DrumPad() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DrumPad).apply(this, arguments));
  }
  ...
  _createClass(DrumPad, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        id: this.props.sound,
        className: "drum-pad"
      }, this.props.DrumPadID, react_default.a.createElement("audio", {
        id: this.props.DrumPadID,
        className: this.props.DrumPadClass,
...
var fontawesome_svg_core_index_es = __webpack_require__(3);
...
fontawesome_svg_core_index_es["b" /* library */].add(faGithub);
...
function (_React$Component) {
  ...
  Header_createClass(Header, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("header", null, react_default.a.createElement("h1", null, "Drum Machine - "), react_default.a.createElement("a", {
        href: "https://github.com/mrwanashraf/drum-machine",
        target: "_blank"
...
function Display_possibleConstructorReturn(self, call) { if (call && (Display_typeof(call) === "object" || typeof call === "function")) { return call; } return Display_assertThisInitialized(self); }

function Display_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Display_getPrototypeOf(o) { Display_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Display_getPrototypeOf(o); }

function Display_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Display_setPrototypeOf(subClass, superClass); }

function Display_setPrototypeOf(o, p) { Display_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Display_setPrototypeOf(o, p); }




var Display_Display_Display =
/*#__PURE__*/
function (_React$Component) {
  Display_inherits(Display, _React$Component);

  function Display() {
    Display_classCallCheck(this, Display);

    return Display_possibleConstructorReturn(this, Display_getPrototypeOf(Display).apply(this, arguments));
  }
  ...
  Display_createClass(Display, [{
    ...
    value: function render() {
      return react_default.a.createElement("section", {
        id: "display"
      }, react_default.a.createElement("p", null, this.props.sound));
    }
  }]);
...
/*#__PURE__*/
function (_React$Component) {
  app_inherits(DrumMachine, _React$Component);

  function DrumMachine(props) {
    var _this;

    app_classCallCheck(this, DrumMachine);

    _this = app_possibleConstructorReturn(this, app_getPrototypeOf(DrumMachine).call(this, props));
    _this.state = {
      sound: ''
    };
    _this.play = _this.play.bind(app_assertThisInitialized(_this));
    _this.currentSound = _this.currentSound.bind(app_assertThisInitialized(_this));
    return _this;
  } // play the drumpad sound based on the event type.


  app_createClass(DrumMachine, [{
    key: "play",
    value: function play(e, drumpad) {
      switch (e.type) {
        case 'click':
    ...
    value: function componentDidMount() {
      ...
      var drumpads = document.querySelectorAll('.drum-pad'); // play the drumpad if the value of key pressed matches the value inside the drumpad.

      document.addEventListener('keydown', function (e) {
        _toConsumableArray(drumpads).map(function (drumpad) {
          if (e.key.toUpperCase() === drumpad.textContent) {
            _this2.play(e, drumpad);
          }
        });
      });
    }
...
react_dom_default.a.render(react_default.a.createElement(app_DrumMachine, null), document.querySelector('#app'));
